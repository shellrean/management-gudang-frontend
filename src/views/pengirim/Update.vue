<template>
  <div class="container mx-auto">
    <div class="mt-10">
      <form @submit.prevent="_updateShipper" class="max-w-sm mx-auto">
        <div class="mb-2">
...
export default {
  ...
  methods: {
    ...mapActions('pengirim', ['updateShipper']),
    async _updateShipper() {
      try {
        await this.updateShipper(this.form)
  ...
  created() {
    this.form = this.$store.state.pengirim.shipper
  }
}
</script>
